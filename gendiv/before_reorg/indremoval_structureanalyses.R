...
butternutgen_24pop <- read.genepop("G:/My Drive/Hoban_Lab_Docs/Projects/Butternut_JUCI/DataFiles/24Populations/11loci/butternut_24pops.gen", ncode = 3)

##now remove individuals with greater than 25% missing data
butternutgen_nomd <- missingno(butternutgen_24pop, type = "geno", cutoff = 0.25, quiet = FALSE, freq = FALSE)
