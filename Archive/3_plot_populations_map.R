...
write.csv(max_min_df, "Genetic_Analyses\\data_files\\geographic_files\\max_min_lonlat_df.csv")

###########################
###### Better Pop Map #####
###########################
setwd("Genetic_Analyses\\data_files\\geographic_files")
...
setwd(paste0(butternut_drive, "\\Genetic_Analyses\\data_files\\geographic_files"))
