...
rownames(allrich_lat_rp) <- c("Lat_AllPops","Lat_woWI", "Lat_WithWI_woNB","Lat_woWI_woNB",
                              "Dist_Edge_AllPops","Dist_Edge_woWI", "Dist_Edge_WithWI_woNB","Dist_Edge_woWI_woNB" )
colnames(allrich_lat_rp) <- c("R2 Linear", "p-value Linear", "R2 Quadratic", "p-value Quadratic")

##rename columns and rownames for hexp r2 and pvalues
rownames(hexp_lat_rp) <- c("Lat_AllPops","Lat_woWI", "Lat_WithWI_woNB","Lat_woWI_woNB",
                              "Dist_Edge_AllPops","Dist_Edge_woWI", "Dist_Edge_WithWI_woNB","Dist_Edge_woWI_woNB" )
colnames(hexp_lat_rp) <- c("R2 Linear", "p-value Linear", "R2 Quadratic", "p-value Quadratic")

##round of significant tables
allrich_lat_rp <- signif(allrich_lat_rp,2)
hexp_lat_rp <- signif(hexp_lat_rp,2)
##write out csv
write.csv(allrich_lat_rp, "genetic_analyses_results\\allrich_rp_df.csv")
write.csv(hexp_lat_rp, "genetic_analyses_results\\hexp_rp_df.csv")
